...
public class G20_PolygonCounter: MonoBehaviour {
    int vertices;
    int polygons;
    ...
    [CustomEditor(typeof(G20_PolygonCounter))]
    public class CountStartEditor : Editor
    {

        G20_PolygonCounter polygonCounter;

        void OnEnable()
        {
            polygonCounter = target as G20_PolygonCounter;
        }
